...
Text documents are often broken up into several sections and subsections. Each section is usually prefaced with a short title or heading that attempts to summarize the topic of the section it precedes. For instance this paragraph is preceded by the heading Heading Tags. The font of the section headings are usually larger and bolder than their subsection headings. This document uses headings to introduce topics such as HTML Documents, HTML Tags, Heading Tags, etc. HTML heading tags can be used to format plain text so that it renders in a browser as large headings. There are 6 heading tags for different sizes: h1, h2, h3, h4, h5, and h6. Tag h1 is the largest heading and h6 is the smallest heading.
      ...
      <div id="wd-p-tag">
        <h4>Paragraph Tag</h4>
        <p id="wd-p-1"> This is a paragraph. We often separate a long set of sentences with
...
<li>Add sugar and cinnamon to it.</li>
<li>Dip bread in the egg mixture and drop it in a hot pan.</li>
<li>Top it with powdered sugar and honey and enjoy.</li>
</ol>
...
<td align="right">15/4/21</td>
<td align="right">85</td>
</tr>

<tr>
<td align="right">Q9</td>
<td align="right">PHP</td>
<td align="right">27/4/21</td>
<td align="right">85</td>
</tr>

<tr>
<td align="right">Q10</td>
<td align="right">RUBY</td>
<td align="right">11/5/21</td>
<td align="right">85</td>
</tr>
